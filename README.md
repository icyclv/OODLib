...
|MaxLogit|[maxlogit.py](./baselines/dnn_based/maxlogit.py)|[Scaling Out-of-Distribution Detection for Real-World Settings](https://proceedings.mlr.press/v162/sun22d/sun22d.pdf) [ICML 2022]|
|KNN|[knn.py](./baselines/dnn_based/knn.py)|[Out-of-Distribution Detection with Deep Nearest Neighbors](https://proceedings.mlr.press/v162/hendrycks22a/hendrycks22a.pdf) [ICML 2022]|
...
|ViM|[vim.py](./baselines/dnn_based/vim.py)|[ViM: Out-Of-Distribution with Virtual-logit Matching](https://openaccess.thecvf.com/content/CVPR2022/papers/Wang_ViM_Out-of-Distribution_With_Virtual-Logit_Matching_CVPR_2022_paper.pdf) [CVPR 2022]|
...
|OptFS|[optfs.py](./baselines/dnn_based/optfs.py)|[Towards Optimal Feature-Shaping Methods for Out-of-Distribution Detection](https://openreview.net/pdf?id=dm8e7gsH0d) [ICLR 2024]|
|Scale|[scale.py](./baselines/dnn_based/scale.py)|[Scaling for Training Time and Post-hoc Out-of-distribution Detection Enhancement](https://openreview.net/forum?id=RDSTjtnqCg) [ICLR 2024]|
...
|NCI|[nci.py](./baselines/dnn_based/nci.py)|[Detecting Out-of-Distribution Through the Lens of Neural Collapse](https://openaccess.thecvf.com/content/CVPR2025/papers/Liu_Detecting_Out-of-Distribution_Through_the_Lens_of_Neural_Collapse_CVPR_2025_paper.pdf) [CVPR 2025]|